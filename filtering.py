#!/usr/bin/env python3
# original: https://github.com/spyysalo/wiki-bert-pipeline
...
def argparser():
    ...
    ap.add_argument('-a', '--avg-len', default=4, type=int,
                    help='minimum average sentence length (lowercase words)')
    ap.add_argument('-d', '--digit-ratio', default=0.075, type=float,
                    help='maximum ratio of digit characters')
    ap.add_argument('-F', '--foreign-ratio', default=0.02, type=float,
    ...
    ap.add_argument('-l', '--langdetect', metavar='LANG', default='hu',
    ...
    ap.add_argument('--language', default='hu',
                    help='language code')
    ap.add_argument('-n', '--no-word-ratio', default=0.2, type=float,
                    help='maximum ratio of lines without word tokens')
    ap.add_argument('-p', '--punct-ratio', default=0.075, type=float,
                    help='maximum ratio of punctuation characters')
    ap.add_argument('-s', '--min-sents', default=3, type=int,
                    help='minimum number of sentences')
    ap.add_argument('-S', '--max-sents', default=1000, type=int,
                    help='maximum number of sentences')
    ap.add_argument('-t', '--min-toks', default=20, type=int,
                    help='minimum number of tokens')
    ap.add_argument('-T', '--max-toks', default=10000, type=int,
                    help='maximum number of tokens')
    ap.add_argument('-u', '--upper-ratio', default=0.1, type=float,
                    help='maximum ratio of uppercase characters')
    ap.add_argument('-w', '--min-words', default=30, type=int,
                    help='minimum number of words')
    ap.add_argument('-W', '--word-chars', default="abcdefghijklmnopqrstuvwxyzáéíóöúüőű",
